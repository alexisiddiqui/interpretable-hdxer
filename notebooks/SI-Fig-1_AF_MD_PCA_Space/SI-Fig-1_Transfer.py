...
experiments = ["AF2-MSAss", "AF2-Cleaned", "Regular-MD", "Better-MD"]#, "Shaw-MD"]
...
for protein in protein_names:
    if protein == "BRD4":
        better_MD_proteins[protein]["index"] = [100/12006*i for i in range(12006)]  # BRD4 has different number of frames
    else:
...
def plot_PCA_index(protein_names: List[str], experiments: List[str], data: pd.DataFrame, experiment_window=["Better-MD"]) -> None:
    """
    ...
    for j, protein in enumerate(protein_names):
        ...
        for i, experiment in enumerate(experiments):
            if "AF2" in experiment:
                ...
                cmap = 'magma'
                index = 'Trajectory %'
            if "Better" in experiment:
                cmap = colour10_MD_cmap
            elif "Regular" in experiment:
...
def plot_PCA_density(protein_names: List[str], experiments: List[str], data: pd.DataFrame, experiment_window=["Better-MD"]) -> None:
    """
...
if __name__ == "__main__":
    ...
    for protein in protein_names[4:]:
